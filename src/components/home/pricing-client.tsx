...
export default function PricingClient({ initialPlans, locale }: { initialPlans: PricingPlan[]; locale: string }) {
    ...
    <section className="relative py-24 md:py-32 bg-[#111118] overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <HomeReveal direction="fade" delay={200}
        ...
        {/* Footer note */}
        <HomeReveal as="p" direction="fade" delay={600}
