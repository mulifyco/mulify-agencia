...
function DashboardIllustration({ active }: { active: boolean }) {
  const bars = [55, 75, 45, 88, 65, 100, 82]
...
function BrowserIllustration({ active }: { active: boolean }) {
  const codeLines = [
...
function GrowthIllustration({ active }: { active: boolean }) {
  return (
    <div className="relative w-full max-w-[380px] mx-auto">
          ...
          {slides.map((slide, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Slide content */}
                <div className="relative z-10 container-tight min-h-screen flex flex-col justify-center pt-28 pb-24">
